...
<p><div align="center">User's manual (coming soon)<br><br><form method="get" action="./../menu.php"><button class="w3-button w3-green w3-round w3-border w3-border-green w3-xlarge w3-round-large" style="width:192px;" id="menu" type="submit">Menu</button></form><br><br></div></p>
</body>
</html>
<?php
} else {
