...
if($_SERVER["REQUEST_METHOD"] == "POST") {
	if(isset($_POST['add_crop'])){
		...
		$query="INSERT INTO crop (crop_name, crop_variety_name) VALUES ('$crop_name', '$crop_variety_name')";
...
<p>      
<button class="w3-button w3-padding-large w3-green w3-round w3-border w3-border-green" id="add_crop" name="add_crop">Add crop</button> <button class="w3-button w3-padding-large w3-green w3-round w3-border w3-border-green" id="cancel" name="cancel">Cancel</button></form><br>
<br><br></div>
</body>
</html>
<?php
