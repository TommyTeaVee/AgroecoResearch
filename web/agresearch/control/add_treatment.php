...
if($_SERVER["REQUEST_METHOD"] == "POST") {
	if(isset($_POST['add_treatment'])){
		...
		$query="INSERT INTO treatment (treatment_name, primary_crop_id, intercropping_crop_id) VALUES ('$treatment_name', $primary_crop_id, $intercropping_crop_id)";
