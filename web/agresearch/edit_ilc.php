...
if(isset($_POST['edit'])){
	...
	$query="UPDATE input_log SET input_log_date='$date', input_age=$age, input_origin='$origin', input_quantity=$quantity, input_cost=$cost, input_comments='$comments' WHERE input_log_id=$id";
